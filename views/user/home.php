...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 mb-8">
        <p class="text-xs font-semibold uppercase tracking-widest text-blue-500 dark:text-blue-400 mb-4">Your Latest Order</p>
        <?php if ($latestOrder): ?>
            <?php
        ...
        <?php else: ?>
            <p class="text-gray-400 dark:text-gray-600 text-sm">You have no orders yet.</p>
        <?php endif; ?>
    </div>
